...
const SignUpPage = () => {
    return (
        <main className="flex flex-col h-dvh justify-center items-center gap-5">
            ...
            <form className="flex flex-col border  gap-10 rounded-2xl p-10 border-2 border-[#725cff]/30 bg-[#10141d]/80 opacity-90 shadow-[0_0_20px_rgba(114,92,255,0.2),0_10px_30px_rgba(0,0,0,0.6)]">
                ...
                <ul className="inputs flex flex-col gap-6">
                    <li className="flex flex-col gap-1.5">
                        <p className="text-[10px] text-neutral-300">아이디 (ID)</p>
                        <input type="text" placeholder="아이디를 입력하세요" className="text-xs font-light border p-3.5 rounded-sm border-neutral-900 placeholder:text-neutral-600 w-full transition duration-300 hover:backdrop-brightness-125 focus:border-primary-500"/>
                    </li>
                    <li className="flex flex-col gap-1.5">
                    ...
                    <li>
                        <input type="submit" value="회원가입" className=""/>
                    </li>
                </ul>
            </form>
        </main>
